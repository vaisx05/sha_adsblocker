...
function run() {
  malwareBlocklist.find(element => {
    if (element === url) {
      ...
      title.textContent = "Sha AdBloaker-Malware Protection";
      ...
      infoPara.textContent = "You were protected from visiting this website by Sha AdBloaker.";

      var p2 = document.createElement("p");
      p2.setAttribute("id", "myPara2");
      p2.textContent = "If this website has been wrongly blocked. Reach to us at: thangarajk176@gmail.com ";
