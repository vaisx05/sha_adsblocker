...
window.addEventListener("load", function () {
    ...
    setInterval(() => {
        ...
        var YT_homepgAd_A = document.getElementsByClassName("style-scope ytd-ad-slot-renderer");
        var YT_homepgAd_B = this.document.getElementsByClassName('style-scope ytd-video-masthead-ad-v3-renderer');
        var YT_searchAd = document.getElementsByClassName("style-scope ytd-promoted-sparkles-text-search-renderer");
        var YT_searchAd_A = document.getElementsByClassName("style-scope ytd-promoted-sparkles-web-renderer");
        var YT_searchAd_B = this.document.getElementsByClassName("style-scope ytd-in-feed-ad-layout-renderer");
        ...
        try {
            if (!window.location.hostname.includes("crunchyroll") && !window.location.hostname.includes("businessinsider") && !window.location.hostname.includes("insider")) {
                var addepthLimit = 3;
